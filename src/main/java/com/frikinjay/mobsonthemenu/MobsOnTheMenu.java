package com.frikinjay.mobsonthemenu;

import com.mojang.blaze3d.systems.RenderSystem;
import com.frikinjay.mobsonthemenu.client.DummyClientWorld;
...
public class MobsOnTheMenu implements ClientModInitializer {

    public static final String MOD_ID = "mobsonthemenu";
    ...
    public void onInitializeClient() {
        ClientTickEvents.END_CLIENT_TICK.register((client) -> {
            if (livingEntity == null) {
                ...
                Entity entity = (EntityType.DROWNED).create(DummyClientWorld.getInstance());

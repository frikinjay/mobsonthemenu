package com.frikinjay.mobsonthemenu.client;
...
public class DummyClientWorld extends ClientWorld {
    ...
    private DummyClientWorld() {
        super(DummyClientPlayNetworkHandler.getInstance(), new Properties(Difficulty.EASY, false, true), null, DummyDimensionType.getInstance(), 0, 0, () -> null, null, false, 0L);
    }
}
